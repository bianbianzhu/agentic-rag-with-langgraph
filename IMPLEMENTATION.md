...
The next implementation work begins Chapter 11 only: Evaluation and release evidence. Read its three linked decisions before planning, then build the single LangSmith dataset, target harness, deterministic and live evaluators, tagged release-v1 workflow, experiment report, and final release gates. Chapters 01 through 10 are verified; preserve their deterministic seams and never let L4 scores compensate for a failed L1-L3 control.
