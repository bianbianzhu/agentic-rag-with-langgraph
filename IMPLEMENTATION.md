...
The next implementation work begins Chapter 10 only: Adversarial and failure scenarios. Read its three linked decisions before planning, then run all required deterministic scenarios through the compiled graph, closing security, isolation, bounded-execution, failure-terminal, and secret-exclusion gaps without introducing Chapter 11 live evaluation work. Chapters 01 through 09 are verified; preserve their public seams unless Chapter 10 evidence requires a compatible extension.
