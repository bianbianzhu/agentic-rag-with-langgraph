...
The next implementation session begins Chapter 06 only: Answers that can be checked. Read its three linked decisions before planning, then add structured citation drafts, deterministic citation-key assignment and validation, one bounded repair, verified rendering, and user-safe answer projection. Chapters 01 through 05 are verified; do not alter their public seams unless Chapter 06 evidence requires a compatible extension.
