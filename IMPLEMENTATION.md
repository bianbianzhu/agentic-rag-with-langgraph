...
| 07 Bounded agentic research | `next` | [graph decision](.scratch/production-agentic-rag-v1/issues/07-prototype-the-reference-system-graph.md), [quality gates](.scratch/production-agentic-rag-v1/issues/10-define-the-evaluation-dataset-and-quality-gates.md) | L1 + L3 routing, refinement, and budget terminals | — |
...
The next implementation work begins Chapter 07 only: Bounded agentic research. Read its two linked decisions before planning, then add explicit planning, authorized retrieval, Evidence sufficiency assessment, at most one query refinement, and code-owned research/model/retrieval budgets with safe terminals. Chapters 01 through 06 are verified; do not alter their public seams unless Chapter 07 evidence requires a compatible extension.
