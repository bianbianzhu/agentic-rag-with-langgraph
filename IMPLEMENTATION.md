...
The next implementation work begins Chapter 08 only: Multi-turn memory without authority drift. Read its three linked decisions before planning, then add trusted Thread binding, role-specific authorized history projection, Standalone Question rewriting, bounded Turn Records plus summary, checkpoint resume, and terminal commit that clears raw Evidence and drafts. Chapters 01 through 07 are verified; do not alter their public seams unless Chapter 08 evidence requires a compatible extension.
